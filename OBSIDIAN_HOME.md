...
```mermaid
graph TD
  A[Website: juapache.github.io] --> B[Research Portfolio]
  A --> C[Data Analysis Portfolio]
  A --> D[Class Portfolio]
  B --> E[Algorithmic Governance]
  B --> F[AI Strategy NLP]
  B --> G[Political Violence CR]
  C --> H[Polarization Spiral]
  C --> I[Trust Paradox]
  D --> J[Peace and Conflict Lessons]
  A --> K[Blog and Public Writing]
  A --> L[Bilingual EN/ES Publishing]
```
